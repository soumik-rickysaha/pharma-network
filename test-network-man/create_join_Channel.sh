...
peer channel create -o localhost:7050 -c pharmachannel --ordererTLSHostnameOverride orderer.example.com -f ./Channels/pharma-channel.tx --outputBlock "./Blocks/pharma-channel.block" --cafile $ORDERER_CA
